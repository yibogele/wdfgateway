...
public class HttpClientUtil {
    ...
    public static String postJson(String url, String paramStr)
        ...
        return post(url, paramStr, "application/json",
                charset, connTimeout, readTimeout);
    }

    public static String postJson(String url, String parameterStr, String charset,
    ...
    public static String postParameters(String url, String parameterStr,
                                        String charset, Integer connTimeout, Integer readTimeout) throws ConnectTimeoutException, SocketTimeoutException, Exception{
        return post(url,parameterStr,"application/x-www-form-urlencoded",
                charset,connTimeout,readTimeout);
    }
